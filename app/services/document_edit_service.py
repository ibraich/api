...
class DocumentEditService:
    ...
    def create_document_edit(self, document_id):
        ...
        document = self.project_document_service.get_document_by_id(document_id)
        if document is None:
    ...
    def soft_delete_document_edit(self, document_edit_id):
        ...
        success = self.__document_edit_repository.soft_delete_document_edit(document_edit_id)
        if not success:
    ...
    def soft_delete_edits_for_document(self, document_id):
        self.__document_edit_repository.soft_delete_document_edits_by_document_id(document_id)
