...
def upgrade():
    ...
    op.create_table('DocumentEditState',
    sa.Column('id', sa.Integer(), autoincrement=True, nullable=False),
    sa.Column('state', sa.String(), nullable=False),
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('state')
    )
    op.create_table('DocumentState',
    sa.Column('id', sa.Integer(), autoincrement=True, nullable=False),
    sa.Column('state', sa.String(), nullable=False),
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('state')
    ...
    op.create_table('ModellingLanguage',
    sa.Column('id', sa.Integer(), autoincrement=True, nullable=False),
    ...
    sa.ForeignKeyConstraint(['modellingLanguage'], ['ModellingLanguage.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    op.create_table('SchemaRelation',
    sa.Column('id', sa.Integer(), autoincrement=True, nullable=False),
    sa.Column('schema_id', sa.Integer(), nullable=False),
    sa.Column('tag', sa.String(), nullable=False),
    sa.ForeignKeyConstraint(['schema_id'], ['Schema.id'], ),
    ...
    sa.ForeignKeyConstraint(['state'], ['DocumentState.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_table('SchemaConstraint',
    sa.Column('id', sa.Integer(), autoincrement=True, nullable=False),
    ...
    sa.ForeignKeyConstraint(['schema_relation_id'], ['SchemaRelation.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_table('DocumentEdit',
    sa.Column('id', sa.Integer(), autoincrement=True, nullable=False),
    sa.Column('state', sa.Integer(), nullable=False),
    sa.Column('document_id', sa.Integer(), nullable=False),
    sa.ForeignKeyConstraint(['document_id'], ['Document.id'], ),
    sa.ForeignKeyConstraint(['state'], ['DocumentEditState.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    op.create_table('DocumentRecommendation',
    sa.Column('id', sa.Integer(), autoincrement=True, nullable=False),
    ...
    sa.ForeignKeyConstraint(['mention_head_id'], ['Mention.id'], ),
    sa.ForeignKeyConstraint(['mention_tail_id'], ['Mention.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_table('TokenMention',
    sa.Column('id', sa.Integer(), autoincrement=True, nullable=False),
