...
class TestDocumentUpload(unittest.TestCase):
    ...
    def test_upload_document_success(self):
        ...
        mock_return = namedtuple(
            "Document",
            ["id", "name", "project_id", "creator_id", "content", "state_id"],
        )
        self.document_repository.create_document.return_value = mock_return(
            1, "test.txt", 1, 1, "This is the content.", 1
        )

        result = self.service.upload_document(1, "test.txt", "This is the content.")
